...
//  http://localhost:3000/playlist -> to the playlist index list via playlist link in the center of the header
...
export default function NavBar() {
  return (
    <nav>
      ...
      <h3>
        <Link to="/songs">Songs 🎶</Link> <Link to="/playlist">Playlist </Link>
      </h3>
      <button>
